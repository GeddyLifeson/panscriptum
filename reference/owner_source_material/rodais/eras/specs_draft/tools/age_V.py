...
def build():
    ...
    # ---------------------------------------------------------------- burgs
    SPECIAL = {
        19: dict(population=4500, kind='town', role='the custodians\' hall, its locks broken; the bridge barricaded with coal-carts in the rising; hungry since the winter, the grain shared by household', cites=['IV-0331', 'IV-0354', 'IV-0376']),
        27: dict(population=20000, kind='city', role='the capital\'s great harbour: the Residency above it stripped, the Company\'s quays and deep-water quay, the burned counting-house and the Mission chapel; the harbour quarter opened its gates to the council', cites=['IV-0031', 'IV-0044', 'IV-0211', 'IV-0356', 'IV-0360', 'IV-0362']),
        354: dict(population=12000, kind='city', role='the heart of the Company\'s pits: overseers\' town, weigh-house burned, the store taken at first light by Mòrag nic Iain\'s crews; the coal line runs from here', cites=['IV-0040', 'IV-0092', 'IV-0243a', 'IV-0325', 'IV-0358']),
        44: dict(population=6000, kind='town', role='the strike town and home of the Lamp-Watch: the walled pithead held eleven days, the book of complaints', cites=['IV-0166', 'IV-0208', 'IV-0213', 'IV-0234', 'IV-0327']),
        419: dict(population=3000, kind='town', role='the silver guild\'s town under the Silver Compact; rose for the council and escorted the Company\'s agents to the coast', cites=['IV-0103', 'IV-0171', 'IV-0337']),
        135: dict(population=6000, kind='town', role='the camp of the deep galleries under the hill, houses built of spoil; the green acre where the Green Death was first marked; the Sloc Mòr is here', cites=['IV-0144', 'IV-0153']),
        224: dict(population=1500, kind='large village', role='the first town drawn on paper, a Company camp on a grid; two streets pulled down for a spoil-tip', cites=['IV-0087', 'IV-0318']),
        383: dict(population=900, kind='large village', role='the Company\'s camp of timber huts at the ford below the new workings, the first settlement made for the pit alone', cites=['IV-0077', 'IV-0163']),
        ...
        313: dict(population=2000, kind='large village', role='its coal stage shelled by a Company steamship from the river and the fishing town behind it set burning; twenty-three dead', cites=['IV-0090', 'IV-0342']),
        255: dict(population=6000, kind='town', role='the rope-walks turned to winding-rope; the constables\' barracks; it shut its gates behind Ashdown and nursed his wounded', cites=['IV-0082', 'IV-0283', 'IV-0336']),
        105: dict(population=800, kind='large village', role=MIXED_TOWNS[105], cites=['IV-0022', 'IV-0110', 'IV-0367']),
        142: dict(population=5000, kind='town', role=MIXED_TOWNS[142], cites=['IV-0117']),
        143: dict(population=5000, kind='town', role=MIXED_TOWNS[143], cites=['IV-0118', 'IV-0122a', 'IV-0262a']),
        ...
        246: dict(population=2500, kind='large village', role='the cellars of the custodians\' rolls, beyond the Residency\'s reach; the rolls of the age sent here at the war\'s end; the Line of Aisling found', cites=['IV-0248', 'IV-0251a', 'IV-0376']),
        152: dict(population=2500, kind='large village', role='the Company\'s second coal port, end of the mule tram-road', cites=['IV-0148', 'IV-0236']),
        351: dict(population=3000, kind='town', role='the Company\'s coal quay, seized by the crews and its mouth blocked with two sunk barges', cites=['IV-0041', 'IV-0326']),
        397: dict(population=2400, kind='large village', role='the deep-water quay for the eastern coal; a village of forty houses become a town of four hundred', cites=['IV-0212']),
        26: dict(population=12000, kind='city', role='the Company\'s first warehouse, broken open for the council\'s companies', cites=['IV-0033', 'IV-0332']),
        77: dict(population=12000, kind='city', role='the druid school\'s hall shut; the grey fever took the Administration\'s physician; the masters\' houses opened as sick-rooms', cites=['IV-0186', 'IV-0247', 'IV-0278']),
        132: dict(population=9000, kind='town', role='Ìomhar Seabhag\'s hawk-shrine, where the hawk company was called', cites=['IV-0284', 'IV-0348']),
        489: dict(population=30000, kind='city', role='the hawk company mustered here and held the road from Ros bheag to the north-west', cites=['IV-0349']),
    }
    ABSENT = {
