...
def build():
    ...
    SPECIAL = {
        ...
        94: dict(population=429, kind='town', role='a city on the southern fishing and the silver of the eastern road; the first stone quay on the island', cites=['II-0230']),
        ...
        419: dict(population=91, kind='large village', role='the silver town of Sliochd Fhearchair: the seam, the weights every trader uses, the stamped rings', cites=['II-0015', 'II-0016', 'II-0064', 'II-0127', 'II-0152', 'II-0153']),
        1: dict(population=539, kind='town', role='the lords\' harbour of the western strait; half the western tolls; the wolf-sworn\'s hall about the white stone at the gate', cites=['II-0091', 'II-0098', 'II-0099', 'II-0100', 'II-0217']),
        ...
        34: dict(population=263, kind='large village', role='seat of Sliochd Raghnaill: boats and not galleries, the first household sentenced under the Law, the refused fisher-families', cites=['II-0028', 'II-0048', 'II-0144', 'II-0203']),
        ...
        22: dict(population=551, kind='large village', role='the market of the southern fishing; the road-guards\' games in a stone-walled field', cites=['II-0068', 'II-0129', 'II-0209']),
        276: dict(population=250, kind='village', role='the slab over the crack; Clann na Ceiste keep the lines', cites=['I-0247', 'IV-0251a']),
        432: dict(population=66, kind='village', role='the grave-keepers of Tuam Cnoc dhìreach, paid by the Hall a handful of coal a season', cites=['II-0044']),
        229: dict(population=147, kind='village', role='the roofed bath-house over the warm springs and its keeper for Dian Cècht', cites=['II-0063', 'II-0224']),
        151: dict(population=76, kind='village', role='rebuilt as a market town after the War of the Roads; the harvest fair at Lùnastal', cites=['II-0093', 'II-0130']),
