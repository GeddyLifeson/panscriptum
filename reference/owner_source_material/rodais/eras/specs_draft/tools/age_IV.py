...
def build():
    ...
    SPECIAL = {
        ...
        23: dict(population=12000, kind='city', walls=True, role='the largest town on the island since LE 969: the market of all the south, Macha\'s great house with its floor of black and white, the copper-workers', cites=['III-0148', 'III-0150', 'III-0198']),
        491: dict(population=3000, kind='town', role='the vein-house above the town: keeper of Crom\'s stone and the custody-book, heir to the Keepers\' Hall; the lot-stones; Dòmhnall Ruadh\'s grave', cites=['III-0006', 'III-0034', 'III-0047', 'III-0138', 'III-0139']),
        ...
        315: dict(population=2700, kind='town', role='the spirit-house of the Old Spirits with the ancestor-posts of the eastern shires; the old Hall', cites=['III-0056', 'III-0165', 'III-0216']),
        422: dict(population=3500, kind='town', walls=True, role='the walled seat of Clann Ìomhair, makers of the ceremonial blades (their folding lost LE 1,569)', cites=['III-0068', 'III-0209']),
        273: dict(population=2500, kind='town', role='Clann Fhearchair\'s town and the king\'s second court near the mountain; the white stone of its hills', cites=['III-0058', 'III-0059', 'III-0181a']),
        76: dict(population=1500, kind='large village', role='once the richest place in the north-east on its salt (the fair of LE 959); its river silted, it keeps the market-court on the headland', cites=['III-0079', 'III-0147', 'III-0166', 'III-0168a']),
        ...
        132: dict(population=2700, kind='town', walls=True, role='walled, with a market inside the landward gate; amber of the Hawk bay; the Fed Hawk\'s refuge', cites=['III-0088a', 'III-0142', 'III-0143']),
        64: dict(population=2400, kind='town', walls=True, role='kept its gates shut to all three claimants and holds its own gates and tolls by grant', cites=['III-0105', 'III-0115']),
        ...
        297: dict(population=2500, kind='town', role='its ridge market at every full moon and the tally-house of the south; its merchants go as one company to Muileann òg', cites=['III-0070a']),
        246: dict(population=800, kind='large village', role='the first paper mill; Beathag nic Thòmais\'s loft of old copies, left to the town on condition nothing in it be burned', cites=['III-0217', 'III-0218', 'III-0221']),
        ...
        34: dict(population=700, kind='large village', role='the ancestor shrine and its feast-market of honey and wax lights', cites=['III-0119a']),
    }
