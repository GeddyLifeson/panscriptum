import{Bn as e,R as t,nn as n,rt as r,z as i}from"./utils-Cob8vHf9.js";import{p as a,t as o}from"./layers-Bh4OWBXX.js";import{a as s}from"./platform-DdqqRmnM.js";import{r as c}from"./draw-landmass-Zto91iBQ.js";import{K as l,St as u,bt as d,it as f,rt as p}from"./index-DsIn6sTp.js";var m=20,h={freshwater:1,salt:2,sinkhole:3,dry:4,lava:5,frozen:6},g=null;function _(e){let t=2166136261,n=e=>{t^=e&255,t=Math.imul(t,16777619)>>>0},r=e=>{if(e)for(let t=0;t<e.length;t++){let r=e[t];n(r),r>255&&n(r>>8)}},i=[options.map.seed,options.map.graph.width,options.map.graph.height,grid.cellsX,grid.cellsY,e.strength,e.riverDepth,e.octaves,e.bakeResolution].join(`|`);for(let e=0;e<i.length;e++)n(i.charCodeAt(e));return r(grid.cells.h),r(pack.cells.r),r(pack.cells.fl),t.toString(36)}function v(e){let t=options.map.graph.height/options.map.graph.width,n=e,r=Math.max(64,Math.round(n*(t<=1?t:1/t)));return t<=1?[n,r]:[r,n]}function y(){let{cellsX:e,cellsY:t}=grid,n=grid.cells.h.length,r=new Uint8Array(n*4),i=Uint8Array.from(grid.cells.h),a=new Float64Array(n),o=new Uint16Array(n);for(let e=0;e<pack.cells.g.length;e++){let t=pack.cells.g[e];a[t]+=pack.cells.h[e],o[t]++}for(let e=0;e<n;e++)o[e]>0&&(i[e]=Math.round(a[e]/o[e]));for(let e=0;e<n;e++){let t=i[e],n=0;if(grid.cells.c[e])for(let r of grid.cells.c[e]){if(i[r]<m)continue;let e=Math.abs(t-i[r]);e>n&&(n=e)}r[e*4]=t,r[e*4+1]=Math.min(n*10,255),r[e*4+3]=255}let s=new THREE.DataTexture(r,e,t,THREE.RGBAFormat,THREE.UnsignedByteType);return s.minFilter=s.magFilter=THREE.LinearFilter,s.needsUpdate=!0,s}function b(e,t){let n=e/options.map.graph.width,r=t/options.map.graph.height,i=e=>e&&e.type!==`ocean`&&e.type!==`lake`,a=document.createElement(`canvas`);a.width=e,a.height=t;let o=a.getContext(`2d`);o.fillStyle=`#000`,o.fillRect(0,0,e,t),o.save(),o.scale(n,r),o.fillStyle=`#fff`;for(let e of pack.features)i(e)&&o.fill(new Path2D(c.getFeaturePath(e)));o.fillStyle=`#000`;for(let e of pack.features)e?.type===`lake`&&o.fill(new Path2D(c.getFeaturePath(e)));o.restore();let s=Math.max(1,grid.spacing*.5*n),l=document.createElement(`canvas`);l.width=e,l.height=t;let u=l.getContext(`2d`);u.fillStyle=`#000`,u.fillRect(0,0,e,t),u.save(),u.scale(n,r),u.fillStyle=u.strokeStyle=`#fff`,u.lineJoin=u.lineCap=`round`;let d=1.1/n;for(let e of pack.rivers||[]){if(!e.cells||e.cells.length<2)continue;let t=e.points&&e.points.length===e.cells.length?e.points:null;try{let n=Rivers.addMeandering(e.cells,t);u.fill(new Path2D(Rivers.getRiverPath(n,e.widthFactor,e.sourceWidth)));let r=n[0][2];for(let t=1;t<n.length;t++){n[t][2]>r&&(r=n[t][2]);let i=Rivers.getOffset({flux:r,pointIndex:t,widthFactor:e.widthFactor,startingWidth:e.sourceWidth});u.lineWidth=Math.max(2*i,d),u.beginPath(),u.moveTo(n[t-1][0],n[t-1][1]),u.lineTo(n[t][0],n[t][1]),u.stroke()}}catch{}}u.restore();let f=s*2,p=document.createElement(`canvas`);p.width=e,p.height=t;let g=p.getContext(`2d`);g.fillStyle=`#fff`,g.fillRect(0,0,e,t),g.save(),g.scale(n,r),g.fillStyle=`#000`;for(let e of pack.features)i(e)&&g.fill(new Path2D(c.getFeaturePath(e)));g.strokeStyle=`#fff`,g.lineJoin=`round`,g.lineWidth=f*2/n;for(let e of pack.features){if(!e||e.type===`ocean`)continue;let t=new Path2D(c.getFeaturePath(e));e.type===`lake`&&g.fill(t),g.stroke(t)}g.restore();let _=document.createElement(`canvas`);_.width=e,_.height=t;let v=_.getContext(`2d`);v.drawImage(l,0,0),v.globalCompositeOperation=`multiply`,v.drawImage(p,0,0),o.globalCompositeOperation=`multiply`,o.filter=`invert(1)`,o.drawImage(_,0,0),o.filter=`none`,o.globalCompositeOperation=`source-over`;let y=document.createElement(`canvas`);y.width=e,y.height=t;let b=y.getContext(`2d`);b.filter=`blur(${s}px)`,b.drawImage(a,0,0);let x=document.createElement(`canvas`);x.width=e,x.height=t;let S=x.getContext(`2d`);S.fillStyle=`rgb(${m},${m},${m})`,S.fillRect(0,0,e,t),S.save(),S.scale(n,r),S.lineJoin=`round`;for(let e of pack.features){if(e?.type!==`lake`)continue;let t=Math.round(Math.max(e.height||m,m)),r=new Path2D(c.getFeaturePath(e));S.fillStyle=S.strokeStyle=`rgb(${t},${t},${t})`,S.lineWidth=s*6/n,S.fill(r),S.stroke(r)}S.restore();let C=document.createElement(`canvas`);C.width=e,C.height=t;let w=C.getContext(`2d`);w.filter=`blur(${s}px)`,w.drawImage(x,0,0);let T=document.createElement(`canvas`);T.width=e,T.height=t;let E=T.getContext(`2d`);E.fillStyle=`#000`,E.fillRect(0,0,e,t),E.save(),E.scale(n,r),E.lineJoin=`round`,E.lineWidth=s*6/n;for(let e of pack.features){if(e?.type!==`lake`)continue;let t=(h[e.subtype]??1)*40,n=new Path2D(c.getFeaturePath(e));E.fillStyle=E.strokeStyle=`rgb(${t},${t},${t})`,E.fill(n),E.stroke(n)}E.restore();let ee=u.getImageData(0,0,e,t).data,te=b.getImageData(0,0,e,t).data,ne=w.getImageData(0,0,e,t).data,re=E.getImageData(0,0,e,t).data,D=new Uint8Array(e*t*4);for(let n=0;n<e*t;n++)D[n*4]=te[n*4],D[n*4+1]=ne[n*4],D[n*4+2]=ee[n*4],D[n*4+3]=re[n*4];let O=new THREE.DataTexture(D,e,t,THREE.RGBAFormat,THREE.UnsignedByteType);return O.minFilter=O.magFilter=THREE.LinearFilter,O.needsUpdate=!0,{texture:O,data:D}}function x(e,t){let n=e;for(let e=0;e<t;e++){let e=[n[0]];for(let t=0;t<n.length-1;t++){let r=n[t],i=n[t+1];e.push([r[0]*.75+i[0]*.25,r[1]*.75+i[1]*.25,r[2]*.75+i[2]*.25],[r[0]*.25+i[0]*.75,r[1]*.25+i[1]*.75,r[2]*.25+i[2]*.75])}e.push(n[n.length-1]),n=e}return n}function S(e,t){let n=document.createElement(`canvas`);n.width=Math.max(256,Math.round(e/4)),n.height=Math.max(2,Math.round(n.width*t/e));let r=n.getContext(`2d`);r.fillStyle=`#000`,r.fillRect(0,0,n.width,n.height);let i=()=>{let e=new THREE.CanvasTexture(n);return e.flipY=!1,e.minFilter=e.magFilter=THREE.LinearFilter,e.generateMipmaps=!1,e};if(!pack.rivers?.length||!pack.cells.fl)return i();let a=[1,1,2,3,5,8,13,21,34].map(e=>e/200),o=[];for(let e of pack.rivers){let t=[];for(let n=0;n<e.cells.length;n++){let r=e.cells[n];if(r<0||pack.cells.h[r]<m)continue;let i=Math.min(pack.cells.fl[r]**.7/500,1),o=n/200+(a[n]??.17),s=e.widthFactor*(o+i)+(e.sourceWidth||0);t.push([pack.cells.p[r][0],pack.cells.p[r][1],s])}t.length>1&&o.push(x(t,2))}let s=n.width/options.map.graph.width,c=grid.spacing*.6,l=[{grow:1,gray:255},{grow:2,gray:140},{grow:3.4,gray:70},{grow:5.2,gray:30}];r.lineCap=`round`,r.lineJoin=`round`,r.globalCompositeOperation=`lighten`;for(let{grow:e,gray:t}of l){r.strokeStyle=`rgb(${t},${t},${t})`;for(let t of o)for(let n=0;n<t.length-1;n++){let[i,a,o]=t[n],[l,u,d]=t[n+1],f=c+(o+d)/2*3;r.lineWidth=Math.max(1,f*e*s),r.beginPath(),r.moveTo(i*s,a*s),r.lineTo(l*s,u*s),r.stroke()}}let{fl:u,h:d,c:f,p,r:h}=pack.cells;for(let e of pack.cells.i){if(d[e]<m||h[e]||!u[e]||u[e]<20)continue;let t=-1,n=d[e];for(let r of f[e])d[r]<n&&(n=d[r],t=r);if(t===-1)continue;let i=Math.min(u[e]/100,1),a=Math.round(12+28*i);r.strokeStyle=`rgb(${a},${a},${a})`,r.lineWidth=Math.max(1,c*.4*s),r.beginPath(),r.moveTo(p[e][0]*s,p[e][1]*s),r.lineTo(p[t][0]*s,p[t][1]*s),r.stroke()}return i()}var C=`
  ...
  `;function T(e,t,n,r,i){let a=new THREE.WebGLRenderTarget(n,r,{format:THREE.RGBAFormat,type:THREE.UnsignedByteType,minFilter:THREE.NearestFilter,magFilter:THREE.NearestFilter,depthBuffer:!1,stencilBuffer:!1}),o=new THREE.RawShaderMaterial({vertexShader:C,fragmentShader:w,uniforms:{uHeight:{value:i.height},uCoast:{value:i.coast},uRivers:{value:i.rivers},uGridSize:{value:new THREE.Vector2(grid.cellsX,grid.cellsY)},uResolution:{value:new THREE.Vector2(n,r)},uAspect:{value:options.map.graph.height/options.map.graph.width},uSeed:{value:(Number.parseInt(options.map.seed,10)%1e5||1)/1e5+1},uStrength:{value:t.strength/50},uRiverDepth:{value:t.riverDepth/100},uOctaves:{value:t.octaves}},depthTest:!1,depthWrite:!1}),s=new THREE.BufferGeometry;s.setAttribute(`position`,new THREE.BufferAttribute(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));let c=new THREE.Mesh(s,o);c.frustumCulled=!1;let l=new THREE.Scene;l.add(c);let u=new THREE.OrthographicCamera(-1,1,1,-1,0,1),d=e.getRenderTarget();e.setRenderTarget(a),e.render(l,u);let f=new Uint8Array(n*r*4);return e.readRenderTargetPixels(a,0,0,n,r,f),e.setRenderTarget(d),a.dispose(),o.dispose(),s.dispose(),f}function E(e){if(!pack.rivers?.length)return;let{heights:t,pixels:n,coast:r,cols:i,rows:a}=e,o=i/options.map.graph.width,s=a/options.map.graph.height,c=(e,r)=>{if(t[e]<=r)return;t[e]=r;let i=Math.round(r*65535);n[e*4]=i>>8,n[e*4+1]=i&255},l=(e,n,l,u,d)=>{let f=l+Math.min(Math.max(u*150,1.5),10),p=e*o-.5,m=n*s-.5,h=Math.max(Math.ceil(p-f),0),g=Math.min(Math.floor(p+f),i-1),_=Math.max(Math.ceil(m-f),0),v=Math.min(Math.floor(m+f),a-1);for(let e=_;e<=v;e++)for(let n=h;n<=g;n++){let a=Math.hypot(n-p,e-m);if(a>f)continue;let o=e*i+n,s=r[o*4+1]/100,u=Math.max(d,s);if(a>l){let e=(a-l)/(f-l);u+=(t[o]-u)*e*e*(3-2*e)}c(o,u)}};for(let n of pack.rivers){if(!n.cells||n.cells.length<2)continue;let r=n.points&&n.points.length===n.cells.length?n.points:null,i;try{i=Rivers.addMeandering(n.cells,r)}catch{continue}if(i.length<2)continue;let a=n.sourceWidth||0,c=0,u=1/0,[d,f]=i[0],p=a;for(let r=0;r<i.length;r++){let[m,h,g]=i[r];g>c&&(c=g);let _=Rivers.getOffset({flux:c,pointIndex:r,widthFactor:n.widthFactor,startingWidth:a}),v=Math.hypot((m-d)*o,(h-f)*s),y=r===0?1:Math.max(Math.ceil(v/.75),1);for(let n=1;n<=y;n++){let r=n/y,i=d+(m-d)*r,a=f+(h-f)*r,s=te(e,t,i,a);s>u+1e-4?l(i,a,(p+(_-p)*r)*o+1,s-u,u):s<u&&(u=s)}d=m,f=h,p=_}}}async function ee(e,t){let n=_(t);if(g&&g.key===n)return g;try{TIME&&console.time(`erosionBake`);let[r,i]=v(t.bakeResolution),a=b(r,i),o={height:y(),coast:a.texture,rivers:S(r,i)},s=T(e,t,r,i,o);for(let e of Object.values(o))e.dispose();let c=new Float32Array(r*i);for(let e=0,t=0;e<c.length;e++,t+=4)c[e]=(s[t]*256+s[t+1])/65535;let l={key:n,heights:c,pixels:s,coast:a.data,cols:r,rows:i};return t.riverDepth>0&&E(l),g=l,TIME&&console.timeEnd(`erosionBake`),g}catch(e){return console.error(`3D erosion bake failed:`,e),g=null,null}}function te(e,t,n,r){let{cols:i,rows:a}=e,o=Math.min(Math.max(n/options.map.graph.width*i-.5,0),i-1),s=Math.min(Math.max(r/options.map.graph.height*a-.5,0),a-1),c=Math.floor(o),l=Math.floor(s),u=Math.min(c+1,i-1),d=Math.min(l+1,a-1),f=o-c,p=s-l,m=t[l*i+c]*(1-f)+t[l*i+u]*f,h=t[d*i+c]*(1-f)+t[d*i+u]*f;return m*(1-p)+h*p}var ne=18,re=100-ne;function D(e,t,n){return g?(te(g,g.heights,e,t)*100-ne)/re*n:0}function O(e){return e===void 0?!!g:!!(g&&g.key===e)}function ie(){g=null}var ae=null,oe=[{color:[.24,.58,.71],density:0},{color:[.89,.78,.57],density:.02},{color:[.75,.68,.54],density:.05},{color:[.62,.61,.34],density:.35},{color:[.45,.59,.25],density:.45},{color:[.25,.48,.18],density:.85},{color:[.17,.4,.15],density:.9},{color:[.11,.36,.13],density:1},{color:[.13,.38,.15],density:1},{color:[.15,.3,.18],density:.85},{color:[.6,.57,.46],density:.12},{color:[.93,.95,.97],density:0},{color:[.26,.4,.23],density:.65}];function se(e,t){let r=oe[t]||oe[0],i=oe[e];if(i)return i;let a=n(pack.biomes[e].color)?.rgb();return a?{color:[a.r/255,a.g/255,a.b/255],density:r.density}:r}function ce(){let{cellsX:e,cellsY:t}=grid,{temp:n,prec:r,h:i,c:a}=grid.cells,o=n.length,s=Float32Array.from(i);for(let e=0;e<3;e++){let e=Float32Array.from(s);for(let t=0;t<o;t++){if(i[t]>=20)continue;let n=s[t],r=1;for(let e of a[t])i[e]<20&&(n+=s[e],r++);e[t]=n/r}s=e}let c=new Uint8Array(o*4);for(let e=0;e<o;e++)c[e*4]=Math.max(0,Math.min(255,n[e]+128)),c[e*4+1]=Math.min(r[e]/30,1)*255,c[e*4+2]=Math.min(i[e]>=20?i[e]:s[e],100)*2.55,c[e*4+3]=255;let l=new THREE.DataTexture(c,e,t,THREE.RGBAFormat,THREE.UnsignedByteType);return l.minFilter=l.magFilter=THREE.LinearFilter,l.needsUpdate=!0,l}function le(){let{cellsX:e,cellsY:t}=grid,{temp:n,prec:r,h:i}=grid.cells,a=n.length,o=new Uint8Array(a),s=new Uint8Array(a),c=pack.cells.g,l=pack.cells.biome;for(let e=0;e<c.length;e++){let t=c[e];s[t]||(o[t]=l[e],s[t]=1)}let u=new Uint8Array(a*4);for(let e=0;e<a;e++){let t=Biomes.getId(r[e]+4,n[e],i[e],!1),{color:a,density:c}=se(s[e]?o[e]:t,t);u[e*4]=a[0]*255,u[e*4+1]=a[1]*255,u[e*4+2]=a[2]*255,u[e*4+3]=c*255}let d=new THREE.DataTexture(u,e,t,THREE.RGBAFormat,THREE.UnsignedByteType);return d.minFilter=d.magFilter=THREE.LinearFilter,d.needsUpdate=!0,d}var ue=`
  precision highp float;
  attribute vec3 position;
  void main() {
    gl_Position = vec4(position.xy, 0.0, 1.0);
...
`;function fe(e,t,{scale:n,maxOutput:r}){if(!t?.pixels||!t?.coast)return null;pe();let i,a,o,s,c,l;try{let{cols:u,rows:d}=t;i=new THREE.DataTexture(t.pixels,u,d,THREE.RGBAFormat,THREE.UnsignedByteType),i.minFilter=i.magFilter=THREE.NearestFilter,i.needsUpdate=!0,a=new THREE.DataTexture(t.coast,u,d,THREE.RGBAFormat,THREE.UnsignedByteType),a.minFilter=a.magFilter=THREE.LinearFilter,a.needsUpdate=!0,o=ce(),s=le();let f=Math.max(u,d),p=Math.min(r,e.capabilities.maxTextureSize,f*2),m=Math.max(p/f,1),h=Math.round(u*m),g=Math.round(d*m),_=e.capabilities.isWebGL2,v=new THREE.WebGLRenderTarget(h,g,{format:THREE.RGBAFormat,type:THREE.UnsignedByteType,generateMipmaps:_,minFilter:_?THREE.LinearMipmapLinearFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,depthBuffer:!1,stencilBuffer:!1});ae=v,v.texture.anisotropy=e.capabilities.getMaxAnisotropy();let y=n*100/82;c=new THREE.RawShaderMaterial({vertexShader:ue,fragmentShader:de,uniforms:{uField:{value:i},uCoast:{value:a},uClimate:{value:o},uBiome:{value:s},uResolution:{value:new THREE.Vector2(h,g)},uFieldSize:{value:new THREE.Vector2(u,d)},uGridSize:{value:new THREE.Vector2(grid.cellsX,grid.cellsY)},uSlopeScale:{value:new THREE.Vector2(y/(options.map.graph.width/u),y/(options.map.graph.height/d))},uAspect:{value:options.map.graph.height/options.map.graph.width},uSeed:{value:(Number.parseInt(options.map.seed,10)%1e5||1)/1e5+1}},depthTest:!1,depthWrite:!1}),l=new THREE.BufferGeometry,l.setAttribute(`position`,new THREE.BufferAttribute(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));let b=new THREE.Mesh(l,c);b.frustumCulled=!1;let x=new THREE.Scene;x.add(b);let S=new THREE.OrthographicCamera(-1,1,1,-1,0,1),C=e.getRenderTarget();return e.setRenderTarget(v),e.render(x,S),e.setRenderTarget(C),v.texture}catch(e){return console.error(`Satellite texture generation failed:`,e),pe(),null}finally{c?.dispose(),l?.dispose(),i?.dispose(),a?.dispose(),o?.dispose(),s?.dispose()}}function pe(){ae&&=(ae.dispose(),null)}var me=10,he=null;function ge(){_e();let e=1024/Math.max(options.map.graph.width,options.map.graph.height),t=document.createElement(`canvas`);t.width=Math.max(64,Math.round(options.map.graph.width*e)),t.height=Math.max(64,Math.round(options.map.graph.height*e));let n=t.getContext(`2d`);n.fillStyle=`#000`,n.fillRect(0,0,t.width,t.height),n.save(),n.scale(e,e),n.lineJoin=n.lineCap=`round`;let r=Math.PI*2/me,i=4/e,a=(e,t)=>`rgb(${Math.round(127.5+127.5*Math.sin(e*r))},${Math.round(127.5+127.5*Math.cos(e*r))},${Math.round(40+t*215)})`,o=e=>Math.min(Math.max((e-.6)/2.4,0),1);for(let e of pack.rivers||[]){if(!e.cells||e.cells.length<2)continue;let t=e.points&&e.points.length===e.cells.length?e.points:null;try{let r=Rivers.addMeandering(e.cells,t),s=0,c=r[0][2],l=0;for(let t=1;t<r.length;t++){let[u,d]=r[t-1],[f,p]=r[t],m=Math.hypot(f-u,p-d);if(m<.01)continue;r[t][2]>c&&(c=r[t][2]);let h=Rivers.getOffset({flux:c,pointIndex:t,widthFactor:e.widthFactor,startingWidth:e.sourceWidth});n.lineWidth=Math.max(2*h,i);let g=Math.max(1,Math.ceil(m/(me/5))),_=m/g;for(let e=0;e<g;e++){let t=e/g,r=(e+1)/g,i=u+(f-u)*t,c=d+(p-d)*t,h=u+(f-u)*r,v=d+(p-d)*r,y=Math.max(0,D(i,c,82)-D(h,v,82))/_;l=Math.max(o(y),l*.55);let b=n.createLinearGradient(i,c,h,v);b.addColorStop(0,a(s+m*t,l)),b.addColorStop(1,a(s+m*r,l)),n.strokeStyle=b,n.beginPath(),n.moveTo(i,c),n.lineTo(h,v),n.stroke()}s+=m}}catch{}}n.restore();let s=new THREE.CanvasTexture(t);return s.minFilter=s.magFilter=THREE.LinearFilter,s.generateMipmaps=!1,he=s,s}function _e(){he&&=(he.dispose(),null)}var k,ve=null,A,j,M,N,P=0,F,I=null,L,R,z,B,ye,V,H,U,W=[],be=[],G=[],K=new Map,q=!1,xe=null,J=null,Se=!1,Y=!1,Ce={value:0},X=document.createElement(`canvas`).getContext(`2d`),we=async(e,t=`viewMesh`)=>{let n=t===`viewGlobe`;f(n?`globe`:`mesh`),Y=!0;let r=await(n?lt(e):Ye(e));return r||(Y=!1,f(`standard`)),r},Z=()=>{et(),j.remove(R),A.setSize(A.domElement.width,A.domElement.height),p()?ft(!0):rt(options.map.graph.width,options.map.graph.height,grid.cellsX,grid.cellsY),$()},Te=()=>{p()?ft():ct()},Ee=()=>{Y=!1,N&&N.dispose(),_t(),I&&I.dispose(),L&&L.dispose(),F&&F.dispose(),ye&&ye.dispose(),V&&V.dispose(),B?.shadow?.map&&B.shadow.map.dispose(),j.background instanceof k.Texture&&j.background.dispose(),ie(),pe(),_e(),yt(),q=!1,xe=null,et(),K.clear(),X.canvas.width=0,X.canvas.height=0,A.renderLists.dispose(),A.dispose(),A.forceContextLoss(),j.remove(R),j.remove(B),j.remove(z),j.remove(H),I=null,f(`standard`)},De=e=>{if(Options.set(t=>t.app.threeD.scale=e),q){Z();return}if(!L)return;let t=L.getAttribute(`position`);for(let e=0;e<t.count;e++)t.setZ(e,ot(e));L.setAttribute(`position`,t),L.computeVertexNormals(),Z()},Oe=e=>{B&&(Options.set(t=>t.app.threeD.sunColor=e),B.color=new k.Color(e),$())},Q=e=>{let t=A?.capabilities?.maxTextureSize;return t?Math.min(d(e),t):d(e)},ke=e=>{Options.set(t=>t.app.threeD.resolutionScale=Q(e)),Z()},Ae=e=>{z&&(Options.set(t=>t.app.threeD.lightness=e),z.intensity=e,$())},je=(e,t,n=options.app.threeD.sun.z)=>{B&&(Options.set(r=>r.app.threeD.sun={x:e,y:t,z:n}),B.position.set(e,t,n),$())},Me=e=>{if(!N)return;p()?Options.set(t=>t.app.threeD.rotateGlobe=e):Options.set(t=>t.app.threeD.rotateMesh=e),N.autoRotateSpeed=e;let t=!N.autoRotate&&!!e,n=N.autoRotate&&!e;N.autoRotate=!!e,t&&gt(),n&&_t()},Ne=()=>{options.app.threeD.extendedWater?(j.background=null,j.fog=null,j.remove(H)):st(options.map.graph.width,options.map.graph.height),Options.set(e=>e.app.threeD.extendedWater=!e.app.threeD.extendedWater),Z()},Pe=()=>{Options.set(e=>e.app.threeD.labels3d=!e.app.threeD.labels3d),options.app.threeD.labels3d?$e().then(()=>Te()):(et(),Te())},Fe=()=>{Options.set(e=>e.app.threeD.subdivide=!e.app.threeD.subdivide),Z()};function Ie(){let e=document.getElementById(`options3dErosion`);e&&(e.checked=options.app.threeD.erosion);let t=document.getElementById(`options3dErosionSection`);t&&(t.style.display=options.app.threeD.erosion?`block`:`none`);let n=document.getElementById(`options3dSubdivide`);n&&(n.disabled=options.app.threeD.erosion)}var Le=()=>{Options.set(e=>e.app.threeD.erosion=!e.app.threeD.erosion),Z()},Re=e=>{Options.set(t=>t.app.threeD.erosionStrength=e),Z()},ze=e=>{Options.set(t=>t.app.threeD.erosionRiverDepth=e),Z()},Be=e=>{Options.set(t=>t.app.threeD.erosionDetail=e),Z()},Ve=e=>{Options.set(t=>t.app.threeD.erosionOctaves=e),Z()},He=()=>{Options.set(e=>e.app.threeD.satellite=!e.app.threeD.satellite),Z()},Ue=()=>{Options.set(e=>e.app.threeD.wireframe=!e.app.threeD.wireframe),Z()},We=(e,t)=>{j&&(Options.set(t=>t.app.threeD.skyColor=e),j.background=new k.Color(e),j.fog&&(j.fog.color=new k.Color(e)),Options.set(e=>e.app.threeD.waterColor=t),V&&(V.color=new k.Color(t)),$())},Ge=e=>{let t=u[e];t&&(je(t.sun.x,t.sun.y,t.sun.z),Oe(t.sunColor),Ae(t.lightness),options.app.threeD.extendedWater&&We(t.skyColor,t.waterColor))},Ke=e=>{let t=Q(Number(e)*1024);Options.set(e=>e.app.threeD.resolutionScale=t),Z()},qe=async()=>{let e=A.domElement.toDataURL(`image/jpeg`),t=document.createElement(`a`);t.download=`${i()}.jpeg`,t.href=e,t.click(),window.tip(s(`Screenshot`),!0,`success`,7e3),window.setTimeout(()=>window.URL.revokeObjectURL(e),5e3)},Je=async()=>{t(await(await Ct()).parse(R),`${i()}.obj`,`text/plain;charset=UTF-8`)};async function Ye(e){if(!await xt())return window.tip(`Cannot load 3d library`,!1,`error`,4e3);j=new k.Scene,z=new k.AmbientLight(13421772,options.app.threeD.lightness),j.add(z),B=new k.SpotLight(options.app.threeD.sunColor,.8,2e3,.8,0,0),B.position.set(options.app.threeD.sun.x,options.app.threeD.sun.y,options.app.threeD.sun.z),B.castShadow=!0,B.shadow.mapSize.width=2048,B.shadow.mapSize.height=2048,j.add(B),A=new k.WebGLRenderer({canvas:e,antialias:!0,preserveDrawingBuffer:!0}),A.setSize(e.width,e.height),A.shadowMap.enabled=!0,A.shadowMap.type=k.PCFSoftShadowMap,Options.set(e=>e.app.threeD.resolutionScale=Q(e.app.threeD.resolutionScale)),options.app.threeD.extendedWater&&st(options.map.graph.width,options.map.graph.height),rt(options.map.graph.width,options.map.graph.height,grid.cellsX,grid.cellsY),M=new k.PerspectiveCamera(70,e.width/e.height,.1,2e3),M.position.set(0,400,500);let t=await dt(M,e);return t?(N=t,N.target&&N.target.set(0,0,0),N.enableDamping=!0,N.dampingFactor=.05,N.screenSpacePanning=!1,N.minDistance=50,N.maxDistance=1e3,N.minZoom=.05,N.maxZoom=4,N.zoomSpeed=.6,N.panSpeed=1.6,N.enableRotate=!0,N.rotateSpeed=.5,N.maxPolarAngle=Math.PI/2,N.minPolarAngle=0,N.autoRotate=!!options.app.threeD.rotateMesh,N.autoRotateSpeed=options.app.threeD.rotateMesh,gt(),N.addEventListener(`change`,$),!0):!1}function Xe(e,t,n){let r=new k.TextureLoader().load(e);r.anisotropy=A.capabilities.getMaxAnisotropy();let i=new k.SpriteMaterial({map:r}),a=new k.Sprite(i);return a.scale.set(t,n,1),a.renderOrder=1,a}async function Ze({text:e,font:t,size:n,color:r,quality:i,letterSpacing:a}){let o=e.split(`|`),s=n*i,c=s*1.25,l=()=>{X.font=`${s}px ${t}`,X.letterSpacing=`${a*i}px`};return l(),X.canvas.width=Math.max(1,...o.map(e=>Math.ceil(X.measureText(e).width))),X.canvas.height=Math.max(1,Math.ceil(c*o.length)),X.clearRect(0,0,X.canvas.width,X.canvas.height),l(),X.fillStyle=r,o.forEach((e,t)=>{X.fillText(e,0,s+c*t)}),Xe(X.canvas.toDataURL(),X.canvas.width/i,X.canvas.height/i)}function Qe(e,t){let n=e-options.map.graph.width/2,r=t-options.map.graph.height/2;return q?[n,D(e,t,options.app.threeD.scale),r]:!U||!R?[n,0,r]:(U.ray.origin.x=n,U.ray.origin.z=r,[n,U.intersectObject(R)[0].point.y,r])}async function $e(){U=new k.Raycaster,U.set(new k.Vector3(0,1e3,0),new k.Vector3(0,-1,0));let e={},t={},n={};function r(e){let t=a({name:e.label?.group||e.group||`burg`,type:`burg`}),n=Number.parseFloat(t.attrs[`font-size`]),r=Number(e?.label?.letterSpacing??t.attrs[`letter-spacing`])||0;return{font:t.attrs[`font-family`],size:n,color:t.attrs.fill||`#000`,letterSpacing:r,elevation:Math.max(5,n*.5),iconSize:Math.max(.3,n*.08),iconColor:`#666`,quality:40}}function i(e){let t=a({name:e.label?.group||`state`,type:`state`}),n=Number.parseFloat(t.attrs[`font-size`]),r=Number(e?.label?.letterSpacing??t.attrs[`letter-spacing`])||0;return{text:e.label?.text||e.name,font:t.attrs[`font-family`],size:n,color:t.attrs.fill||`#000`,letterSpacing:r,elevation:20,quality:80}}function s(t,n){if(!e[t]){let r=new k.MeshPhongMaterial({color:n});r.wireframe=options.app.threeD.wireframe,e[t]=r}return e[t]}function c(e,n){let r=`${e}_${n.toFixed(2)}`;return t[r]||(t[r]=new k.CylinderGeometry(n*2,n*2,n,16,1)),t[r]}function l(e,t){return n[e]||(n[e]=new k.LineBasicMaterial({color:t})),n[e]}for(let e=1;e<pack.burgs.length;e++){let t=pack.burgs[e];if(t.removed)continue;let n=r(t),[i,a,u]=Qe(t.x,t.y);if(o.isOn(`labels`)&&!t.label?.hidden){let e=await Ze({text:t.label?.text??t.name??``,...n});e.position.set(i,a+n.elevation,u),e.size=n.size,W.push(e),j.add(e)}if(o.isOn(`burgIcons`)){let e=c(t.group,n.iconSize),r=s(t.group,n.iconColor),o=new k.Mesh(e,r);o.position.set(i,a,u),be.push(o),j.add(o);let d=l(t.group,n.iconColor),f=a+n.iconSize/2,p=a+n.elevation-n.size*.5,m=[new k.Vector3(i,f,u),new k.Vector3(i,p,u)],h=new k.BufferGeometry().setFromPoints(m),g=new k.Line(h,d);G.push(g),j.add(g)}}if(o.isOn(`labels`))for(let e=1;e<pack.states.length;e++){let t=pack.states[e];if(t.removed||t.label?.hidden)continue;let[n,r,a]=Qe(t.pole[0],t.pole[1]),o=i(t),s=await Ze(o);s.position.set(n,r+o.elevation,a),s.size=o.size,W.push(s),j.add(s)}ht()}function et(){if(j){for(let e of W)j.remove(e),e.material.map&&e.material.map.dispose(),e.material.dispose(),e.geometry.dispose();W=[];for(let e of be)j.remove(e),e.material.dispose(),e.geometry.dispose();be=[];for(let e of G)j.remove(e),e.material.dispose(),e.geometry.dispose();G=[]}}async function tt(){let e=await l.ExportMap.getMapURL(`mesh`,{noLabels:options.app.threeD.labels3d,noWater:options.app.threeD.extendedWater,noViewbox:!0,fullMap:!0});return new Promise(t=>{let n=document.createElement(`canvas`),r=n.getContext(`2d`);n.width=options.app.threeD.resolutionScale,n.height=options.app.threeD.resolutionScale;let i=new Image;i.src=e,i.onload=()=>{r.drawImage(i,0,0,n.width,n.height),n.toBlob(e=>{let r=window.URL.createObjectURL(e);window.setTimeout(()=>{n.remove(),window.URL.revokeObjectURL(r)},100),t(r)})}})}async function nt(){if(!A)return null;I&&I.dispose();let e=await tt();return await new Promise(t=>{I=new k.TextureLoader().load(e,e=>{t(e)},void 0,()=>t(null))}),I&&(I.anisotropy=A.capabilities.getMaxAnisotropy()),I}async function rt(e,t,n,r){if(!j||!A)return;if(yt(),K=new Map,pack.cells?.g&&pack.cells?.i)for(let e of pack.cells.i){let t=pack.cells.g[e];K.has(t)||K.set(t,e)}let i=!!(options.app.threeD.satellite&&!p()&&!options.app.threeD.wireframe);!options.app.threeD.wireframe&&!i&&await nt(),F&&F.dispose(),F=new k.MeshLambertMaterial,options.app.threeD.wireframe?F.wireframe=!0:i||(F.map=I,F.transparent=!0);let a=null;if((options.app.threeD.erosion||i)&&!p()){let e=options.app.threeD.erosionDetail>=2048?4096:options.app.threeD.erosionDetail>512?2048:1024,t=options.app.threeD.resolutionScale>=8192?8192:options.app.threeD.resolutionScale>=4096?2048:1024,n=i?Math.max(e,t):e,r=Math.min(A.capabilities.maxTextureSize,8192);a=await ee(A,{strength:options.app.threeD.erosion?options.app.threeD.erosionStrength:0,riverDepth:options.app.threeD.erosion?options.app.threeD.erosionRiverDepth:0,octaves:options.app.threeD.erosion?options.app.threeD.erosionOctaves:1,bakeResolution:Math.min(n,r)}),!a&&options.app.threeD.erosion&&(console.warn(`3D erosion bake failed, falling back to standard mesh`),window.tip(`Eroded terrain is not supported on this device`,!1,`warn`,4e3),Options.set(e=>e.app.threeD.erosion=!1),Ie())}if(q=!!a&&!!options.app.threeD.erosion,xe=a,i||(pe(),_e()),L&&L.dispose(),R&&j.remove(R),q){let n=options.app.threeD.erosionDetail,r=e>=t?n:Math.max(2,Math.round(n*e/t)),i=e>=t?Math.max(2,Math.round(n*t/e)):n;L=new k.PlaneGeometry(e,t,r-1,i-1);let a=L.getAttribute(`position`);for(let n=0;n<a.count;n++){let r=a.getX(n)+e/2,i=t/2-a.getY(n);a.setZ(n,D(r,i,options.app.threeD.scale))}L.computeVertexNormals(),R=new k.Mesh(L,F)}else{L=new k.PlaneGeometry(e,t,n-1,r-1);let i=L.getAttribute(`position`);for(let e=0;e<i.count;e++)i.setZ(e,ot(e));if(L.setAttribute(`position`,i),L.computeVertexNormals(),options.app.threeD.subdivide){await St();let e=window.loopSubdivision.modify(L,1,{split:!0,uvSmooth:!1,preserveEdges:!0,flatOnly:!1,maxTriangles:1/0});R=new k.Mesh(e,F)}else R=new k.Mesh(L,F)}if(i){let e=a&&fe(A,a,{scale:options.app.threeD.scale,maxOutput:d(options.app.threeD.resolutionScale)});e?(F.map=e,bt(F,ge()),vt()):(F.map=await nt(),F.transparent=!0)}R.rotation.x=-Math.PI/2,R.castShadow=!0,R.receiveShadow=!0,j.add(R),$(),options.app.threeD.labels3d&&(await $e(),$())}var it=18,at=100-it;function ot(e){let t=grid.cells.h[e],n=null;if(t<20?n=e:grid.cells.c[e]&&(n=grid.cells.c[e].find(e=>grid.cells.h[e]<20)??null),n!==null){let e=K.get(n);if(e===void 0)return 0;let t=pack.cells.f[e];if(t===void 0)return 0;let r=pack.features[t];return((r.type===`lake`&&r.height?r.height:20)-it)/at*options.app.threeD.scale}return(t-it)/at*options.app.threeD.scale}function st(e,t){j&&(j.background=new k.Color(options.app.threeD.skyColor),ye=new k.PlaneGeometry(e*10,t*10,1),V=new k.MeshBasicMaterial({color:options.app.threeD.waterColor}),j.fog=new k.Fog(j.background,500,3e3),H=new k.Mesh(ye,V),H.rotation.x=-Math.PI/2,H.position.y-=3,j.add(H))}async function ct(){if(!F||!A)return;if(options.app.threeD.satellite&&xe&&!p()&&!options.app.threeD.wireframe){let e=fe(A,xe,{scale:options.app.threeD.scale,maxOutput:d(options.app.threeD.resolutionScale)});if(e){F.map=e,$();return}}I&&I.dispose();let e=await tt();window.setTimeout(()=>window.URL.revokeObjectURL(e),4e3),I=new k.TextureLoader().load(e,$),F.map=I}async function lt(e){if(!await xt())return window.tip(`Cannot load 3d library`,!1,`error`,4e3),!1;j=new k.Scene,j.background=new k.TextureLoader().load(`https://i0.wp.com/azgaar.files.wordpress.com/2019/10/stars-1.png`,$),A=new k.WebGLRenderer({canvas:e,antialias:!0,preserveDrawingBuffer:!0}),A.setSize(e.width,e.height),Options.set(e=>e.app.threeD.resolutionScale=Q(e.app.threeD.resolutionScale)),F&&F.dispose(),F=new k.MeshBasicMaterial,ft(!0),M=new k.PerspectiveCamera(45,e.width/e.height,.1,1e3),M.translateZ(5);let t=await ut(M,A.domElement);return t?(N=t,N.zoomSpeed=.25,N.minDistance=1.5,N.maxDistance=10,N.autoRotate=!!options.app.threeD.rotateGlobe,N.autoRotateSpeed=options.app.threeD.rotateGlobe,N.mouseButtons={LEFT:k.MOUSE.ROTATE,MIDDLE:k.MOUSE.DOLLY,RIGHT:k.MOUSE.PAN},N.screenSpacePanning=!0,N.minPolarAngle=0,N.maxPolarAngle=Math.PI,N.addEventListener(`change`,$),!0):!1}async function ut(e,t){return k.OrbitControls?new k.OrbitControls(e,t):new Promise(n=>{let r=document.createElement(`script`);r.src=`libs/orbitControls.min.js`,document.head.append(r),r.onload=()=>n(k.OrbitControls?new k.OrbitControls(e,t):!1),r.onerror=()=>n(!1)})}async function dt(e,t){return k.MapControls?new k.MapControls(e,t):new Promise(n=>{let r=document.createElement(`script`);r.src=`libs/mapControls.min.js`,document.head.append(r),r.onload=()=>n(k.MapControls?new k.MapControls(e,t):!1),r.onerror=()=>n(!1)})}async function ft(t){let n=options.map.geography.coordinates.latT>179;Options.set(e=>e.app.threeD.resolutionScale=Q(e.app.threeD.resolutionScale));let r=options.app.threeD.resolutionScale,i=Math.max(1,Math.round(r/2)),a=e(options.map.geography.coordinates.latT/180*i),o=n?a*2:e(options.map.graph.width/options.map.graph.height*a),s=n?0:(90-options.map.geography.coordinates.latN)/180*i,c=n?0:o/4,u=document.createElement(`canvas`).getContext(`2d`);if(u.canvas.width=r,u.canvas.height=i,!n){let e=new Image;e.onload=()=>{u.drawImage(e,0,0,r,i)},e.src=`data:image/png;base64,`}let d=new Image;d.onload=()=>{u.drawImage(d,c,s,o,a),I&&I.dispose(),I=new k.CanvasTexture(u.canvas),F.map=I,t&&pt()},d.src=await l.ExportMap.getMapURL(`mesh`,{noScaleBar:!0,fullMap:!0,noVignette:!0})}function pt(){!Y||!j||!F||(R&&j.remove(R),L&&L.dispose(),L=new k.SphereGeometry(1,64,64),R=new k.Mesh(L,F),j.add(R),N?.autoRotate?gt():$())}var mt=r(ht,200);function $(){!Y||!A||!j||!M||(A.render(j,M),mt())}function ht(){if(M)for(let[e,t]of W.entries()){let n=t.position.distanceTo(M.position),r=n<100*t.size&&n>t.size*6;t.visible=r,G[e]&&(G[e].visible=r)}}function gt(){if(!Y||Se)return;Se=!0;let e=()=>{P=requestAnimationFrame(e),N?.update&&N.update()};P=requestAnimationFrame(e)}function _t(){Se=!1,cancelAnimationFrame(P),P=0}function vt(){if(J)return;let e=t=>{J=requestAnimationFrame(e),Ce.value=t/1e3,$()};J=requestAnimationFrame(e)}function yt(){J&&cancelAnimationFrame(J),J=null}function bt(e,t){e.onBeforeCompile=e=>{e.uniforms.uTime=Ce,e.uniforms.uFlow={value:t},e.fragmentShader=`uniform float uTime;
        ...
        `+e.fragmentShader.replace(`#include <map_fragment>`,`#include <map_fragment>
          ...
          diffuseColor.a = 1.0;`)}}function xt(){return k?Promise.resolve(!0):(ve||=new Promise(e=>{let t=document.createElement(`script`);t.src=`libs/three.min.js`,document.head.append(t),t.onload=()=>{k=window.THREE,e(!0)},t.onerror=()=>e(!1)}),ve)}function St(){return window.loopSubdivision?Promise.resolve(!0):new Promise(e=>{let t=document.createElement(`script`);t.src=`libs/loopsubdivison.min.js`,document.head.append(t),t.onload=()=>e(!0),t.onerror=()=>e(!1)})}function Ct(){return k.OBJExporter?new k.OBJExporter:new Promise(e=>{let t=document.createElement(`script`);t.src=`libs/objexporter.min.js?v=1.89.35`,document.head.append(t),t.onload=()=>e(k.OBJExporter?new k.OBJExporter:!1),t.onerror=()=>e(!1)})}export{we as create,D as heightAt,O as isCached,Z as redraw,Je as saveOBJ,qe as saveScreenshot,We as setColors,Be as setErosionDetail,Ve as setErosionOctaves,ze as setErosionRiverDepth,Re as setErosionStrength,Ae as setLightness,Ke as setResolution,ke as setResolutionScale,Me as setRotation,De as setScale,je as setSun,Oe as setSunColor,Ge as setTimeOfDay,Ee as stop,Fe as toggle3dSubdivision,Le as toggleErosion,Pe as toggleLabels,He as toggleSatellite,Ne as toggleSky,Ue as toggleWireframe,Te as update};