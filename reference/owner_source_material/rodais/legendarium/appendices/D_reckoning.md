...
The harbour scribe gives the day of the Setting-Out as {{date:III-0023}} and the day of the sunwise turn as {{date:III-0024}}. The two fall on one day. The custody-book, however, enters the turn under a later day than the sailing, after the next Samhain. No account explains that gap of half a year, and the keepers have left both entries where they stand. Section II gives what the gap did to the count. The count now kept on Rodos follows the harbour scribe and sets both in 1 DE.

### II. How the Ages Reckoned Before the Diosal

**The Ancient Age.** The Ancient Age kept no count of years that anyone has found. Its people counted other things. The Seann-Dhaoine cut strokes on stones at the edges of their middens, one stone to a household, and the counting of the dead began on {{date:I-0091}}. The tally wall at Seann Warr grew to some three thousand strokes, and in one stretch the tallies of three coasts thicken together ({{date:I-0094}}). These are counts of the dead. None of them has been read as a count of years.
...
Leabharlann Muileann chaol, founded {{date:V-0070}}, took the table as one of its first possessions and extended it. When the library absorbed the provincial archives ({{date:V-0226}}), the table was checked against them and corrected where the archives knew better. The first keeper, Ailean Leabhar, disliked the saying *a chur san Leabharlann*, "to put it in the Library," on the ground that the library settles nothing and only keeps it ({{date:V-0072}}). The table should be read in the same spirit.
...
**The Long War** left two days. The Battle of Àth leathan, {{date:V-0318}}, opened *An Cogadh Fada*. Tuathaich families have raised a cairn without leave on the field at {{place:marker:18}}, and it grows by a stone or two whenever the patrols pass; whether they come on the day of the battle nobody has written down. The Battle of Muileann ghlas, {{date:V-0352}}, ended the war, and the regiments raised in the campaign keep that day at their stations. So the two days are kept by two peoples, and the library, whose war archive is sealed ({{date:V-0365}}), holds what it can of both.
