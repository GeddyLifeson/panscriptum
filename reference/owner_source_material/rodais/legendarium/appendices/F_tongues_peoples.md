...
Here is gathered what the rolls and chronicles hold of the peoples who have lived on Rodos and of the
...
people-ending *-aich*; a single person is a *Ròdach*. Writers of the humans' tongue called them
...
note with some unease, there was never again a time on Rodos when no family held more years of life
than any other.

**The kingdom.** After the Severance the state restyled itself Rìoghachd Ròdais, the Kingdom of
Rodos ({{date:V-0007}}), and Niall was crowned at Cathair dhearg ({{date:V-0012}}). The rulers since
are set down in Appendix A. Here it is enough to say that the kingdom is a Ròdach kingdom: its schools
teach in Ròdais "and it has no others" ({{date:V-0032}}), and the old apprentice-binding custom,
when it was revived, was reserved for Ròdaich applicants only ({{date:V-0059}}).

**The sea.** The Ròdaich have always been a people of the coast as much as of the mountain. The largest
towns on the map today stand on the sea or on the rivers that run down to it, and the two largest bear a name older than Ròdais:
...
nothing is left that Rodos would know" ({{date:III-0029}}). The departed stand in the
...
descend from the departed, no one on Rodos knows.
...
**The camps.** What the humans built for themselves on Rodos they built for the pit. The camp of
timber huts at Àth ìseal was the first settlement on the island raised for the pit and for nothing else
({{date:IV-0077}}); Baile dhomhain was laid out on a grid by a Company surveyor, the first Ròdach
town drawn on paper before it was built ({{date:IV-0087}}); the camp at Achadh dhomhain was built
of spoil ({{date:IV-0144}}). Ròdach hands worked the camps and human officers ruled them, and the
...
the Mission's list ({{date:IV-0096}}). Human families lived on Rodos as well as human officers:
...
({{date:IV-0377}}). Whatever way had let the humans reach Rodos was shut, and those still on the island were
...
*na Tuathaich*, the northerners, from *tuath*, north, with the same *-aich* that makes *Ròdaich*;
...
some 543,000 people in them. The Ròdaich hold the other 441. The Tuathaich country is some fifteen parts in a hundred of the island's land, the windy coast of the far north-west among it, and the Ròdaich country the other eighty-five (Appendix H). The largest Tuathaich towns are these:
...
Ròdais is the tongue of Rodos, spoken by the Ròdaich in every age. Three
...
**How Ròdais names new things.** Ròdais was long spoken on an island that few new things reached, and
it was slow to borrow. The humans brought many new things, and the kingdom after them more. In the first
generations after the Crossing the Ròdaich named nearly all of them from old roots, calling the thing by
what it does or what it is like: head first, the describer after, hyphenated, two elements and seldom
three. Many of these kennings are still the common words. The loans Ròdais did take came mostly later:
...
are old Ròdais, or the cant of the wrights, or something else, no one has shown.
...
hard like shells in a stone, and never put into Ròdais.
...
*Vell*, *w* in *Cwen* and *Warr*. Everywhere else Ròdais writes the sound *sk* as *sc*, yet no scribe
...
or only the Ròdaich's word for places they found already named (the second is the common
...
({{date:I-0017}}), in the script that is found again on the standing stones. It is not Ròdais. It
...
({{date:IV-0058}}). The Mission's school at Ros dhomhain taught Ròdach children in the humans'
tongue ({{date:IV-0121}}); a generation later Iain Maor, the first overseer schooled there, kept his
reports in the humans' tongue and his household in Ròdais ({{date:IV-0180}}). The Levy's officers
read the names of the chosen at Caol mhòr from a list in the humans' tongue, and the custodians took
the names down again in Ròdais, "that they may know whom to look for" ({{date:IV-0182}}).
...
the war they lost ({{date:VI-0119}}), and *seann-chunntas*, an old reckoning, which official Ròdach
...
**Personal names.** Ròdach names are the old given names of the island: Ailean, Beathag, Catrìona, Dòmhnall,
...
oldest Ròdais words in stone. When they were cut no roll tells. The stones were raised in
...
child ({{date:III-0084}}). A mill at Muileann chaol began making paper from rags, the first on Rodos,
...
This history is written in English for readers who have no Ròdais, and some account is owed of what
...
wanted. Where a Ròdais phrase is translated, the translation follows it in quotation marks, as a help
to the reader; the Ròdais stands first. The six ages have Ròdais names and are also given English ones
...
this history it is written *Rodos*, the form the humans used, and the one most readers will have
