...
Appendices: a prose book for each of the six ages, dated annals of every event, appendices (rulers and houses,
...
| `annals/age_I..VI.json` | The annals as written: events in order, each with its place on the map. No dates are typed by hand. Age VI (from the first working dubhan) was split from Age V; its events keep, as `seed`, the Age V id they were first dated under, so their days do not move. |
...
| `reckoning.py` | Gives every event its day, month and year → `annals_dated.json`, and holds the six ages and their eras (`AGES`) and the stretches of years they are dated across (`STRETCHES`). |
| `book/age_I..VI.md` | The prose of each age. |
...
| Age | Ròdais | English | Era | Year 1 |
|---|---|---|---|---|
| I | An Aois Àrsaidh | the Ancient Age | Linn na Fèithe, the Vein Era (VE) | the crack in the stone, I-0001 |
| II | An Aois Naomh | the Holy Age | Linn an Teine, the Flame Era (FE) | the Binding of the First Flame, II-0001 |
| III | An Aois Scaraidh | the Age of Sundering | Linn na Tìre, the Landfall Era (LE) | land found across the water, III-0001 |
| IV | An Aois Choigreach | the Age of Strangers | Linn an Acair, the Anchor Era (AE) | the Crossing, IV-0001 |
| V | An Aois Rìoghachd | the Age of the Kingdom | Linn an Dealachaidh, the Severance Era (SE) | the Tuathaich homeland, V-0001 |
| VI | An Aois Dhubhain | the Age of Dubhan | Linn an Dubhain, the Dubhan Era (DE) | the first working dubhan, VI-0001 |
...
- The **year** is built from three album release years, then the **month** and **day** from other albums:
  ...
  year 0. The stretches (`reckoning.STRETCHES`) are the old table's round bounds of the first five ages; Ages V and VI
  are dated as one stretch, as they were before Age VI was counted apart. Windows are in the continuous count.
