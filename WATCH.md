...
round 354  ·  last run 2026-09-04 23:14

## Structure

- modules that will not import: **0**
- files that will not parse: **0** of 294,893 inspected (deep scan as of round 349)
...
- **binding_health.py** `binding_verdict` — [HIGH] The function is called but not defined in this slice of code
  - says: A function that returns a verdict about a wiki's binding based on its sitename and sources
